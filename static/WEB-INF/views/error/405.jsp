...
<head>
<link href="<%=request.getContextPath() %>/fc/css/style.css" rel="stylesheet" type="text/css" />
<link href="<%=request.getContextPath() %>/fc/css/public.css" rel="stylesheet" type="text/css" />
	<title>不允许操作</title>
	<style type="text/css">
	*{padding:0;margin:0;}
...
<div id="_151118all">
		<div class="_151118a_title">
			 <img class="_151118ac_img" style="" src="<%=request.getContextPath() %>/static/images/error!.png"/>
			<span style="font-size:72px;" >405</span><span style="font-style: italic;font-size:40px;padding-left:20px;">Error</span>
		</div>
