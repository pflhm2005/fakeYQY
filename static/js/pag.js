    ...
    $.fn.pageFun = function (options) {
        ...
        var Method = {
            ...
            handleEvent: function handleEvent() {
                ...
                opts.btnSure.on("click", function () {
                    /*输入页码 跳转*/
            ...
            xhhtml: function xhhtml(index, count) {
                for (var i = (index - 1) * opts.displayCount; i < count; i++) {
                    opts.pageDiv.append(opts.dataFun(opts.res[i]));
                }
                opts.keuInput.val(index);
            },
            showPageindex: function showPageindex(min, max, index) {
...
})(__WEBPACK_IMPORTED_MODULE_0_jquery___default.a, window, document, undefined);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__nativeJs_page__ = __webpack_require__(29);
...
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    created: function created() {
        ...
        __WEBPACK_IMPORTED_MODULE_1_jquery___default()(".pageBox").pageFun({
